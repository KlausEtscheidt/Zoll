/// <summary>SQLite-Datenbank-Abfragen für das Programm DigiLek</summary>
/// <remarks>
/// Die Unit ist identisch zu QryAccess arbeitet jedoch mit einer
/// Access-Datenbank.
///| Die SQL-Strings sind nicht identisch zu QryAccess, da SQLite teilweise
