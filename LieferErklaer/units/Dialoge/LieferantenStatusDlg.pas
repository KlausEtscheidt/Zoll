...
const
  msg = 'Die Restg�ltigkeit betr�gt weniger als 100 Tage.' + #13
      + 'Soll das wirklich so �bernommen werden ?';
begin
  ...
  //Wenn Lekl abgegeben, Restg�ltigkeit pr�fen
...
//      exit;
    ...
    //Lieferanten-Status-Daten aus Datenbank in DataSource f�r Formular
