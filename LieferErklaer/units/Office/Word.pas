...
begin
  ...
  if DatensatzFelder.FieldByName('telefax').AsString = '' then
    raise Exception.Create('Keine Faxnummer f�r diesen Lieferantenvorhanden.');
  ...
  try
    ...
    with DatensatzFelder do
      begin
        //Gibt es einen speziellen Ansprechpartner dieseer Firma f�r Lekl im UNIPPS
  ...
  //  Sleep(500);
    ...
    try
      //Schlie�en falls nicht geschehen
